...
public:
  ...
  auto audio_save(std::string path) const
      -> std::expected<void, NeoVIMICErrType>;
  auto audio_start(uint32_t sample_rate) const
      -> std::expected<void, NeoVIMICErrType>;
